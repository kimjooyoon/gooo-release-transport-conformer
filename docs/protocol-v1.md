# Release transport protocol v3

The `.gooo` declaration is the semantic source of truth. Its eleven activities
...
reconciliation, symbolic release-target resolution through the peeled annotated
...
The fixed eighteen scenarios deliberately include both healthy observations and
...
source target, and assets match exactly or its assets are empty. A symbolic
