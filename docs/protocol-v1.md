...
The `.gooo` declaration is the semantic source of truth. Its nine activities
...
reconciliation, annotated-tag target verification, public asset-digest
verification, counterexample preservation, and receipt emission.
...
The fixed fourteen scenarios deliberately include both healthy observations and
...
source target, and assets match exactly or its assets are empty. Drafts and
