...
jq -e '
  .schema == "gooo/release-transport-conformer/conformance-receipt/v1" and
  .decision == "CLOSED" and .conformance_closed == true and .denominator == 12 and
  .summary == {CLOSED:4, UNKNOWN:3, REFUTED:5} and
  ...
  (.activity_binding_counts | length) == 8 and
